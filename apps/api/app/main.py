...
from app.routers import admin, admin_management, analytics, events, foods, health, ingredients, saved, search, shopping_list, suggestions, vendors
...
app = FastAPI(
    ...
    openapi_tags=[
        ...
        {"name": "Saved", "description": "Per-user saved dishes and places."},
...
app.include_router(shopping_list.router, prefix=settings.api_v1_prefix)
